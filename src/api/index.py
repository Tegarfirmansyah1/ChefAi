...
class handler(BaseHTTPRequestHandler):
    ...
    def do_OPTIONS(self):
        """Menangani CORS preflight requests dari browser."""
    ...
    def do_POST(self):
        # Set header CORS untuk respons utama
        self.send_header('Access-Control-Allow-Origin', '*')
        ...
        try:
            ...
            answer = result.get('answer', 'Maaf, terjadi kesalahan dalam menghasilkan jawaban.')
